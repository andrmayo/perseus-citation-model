...
class TestGenerateBioLabels:
    ...
    @pytest.fixture
    def mock_tokenizer_with_special_tokens(self, mocker):
    ...
    def test_simple_bibl_tag(self, mock_tokenizer_with_special_tokens):
        """Test basic BIBL tag generates correct BIO labels."""
        # [CLS] [BIBL_START] word1 word2 [BIBL_END] [SEP]
        input_ids = [0, 100, 10, 11, 101, 2]

        labels = generate_bio_labels(input_ids, mock_tokenizer_with_special_tokens)
    ...
    def test_simple_quote_tag(self, mock_tokenizer_with_special_tokens):
    ...
    def test_simple_cit_tag(self, mock_tokenizer_with_special_tokens):
    ...
    def test_outside_tags(self, mock_tokenizer_with_special_tokens):
    ...
    def test_mixed_tags_and_outside(self, mock_tokenizer_with_special_tokens):
    ...
    def test_multiple_tags_same_type(self, mock_tokenizer_with_special_tokens):
    ...
    def test_nested_tags(self, mock_tokenizer_with_special_tokens):
    ...
    def test_different_tag_types_sequential(self, mock_tokenizer_with_special_tokens):
    ...
    def test_padding_tokens(self, mock_tokenizer_with_special_tokens):
    ...
    def test_empty_tag(self, mock_tokenizer_with_special_tokens):
    ...
    def test_label_count_matches_input_count(self, mock_tokenizer_with_special_tokens):
