...
class TestExtractExistingCitations:
    """Test CitationTagger.extract_existing_citations method."""
    ...
    def test_single_bibl_tag(self, tagger):
        ...
        stripped, citations = tagger.extract_existing_citations(xml)

        assert stripped == '<p>See Hdt. 8.82 for details.</p>'
        assert len(citations) == 1
        assert citations[0] == (7, 17, 'BIBL')  # "Hdt. 8.82" at positions 7-17
    ...
    def test_single_quote_tag(self, tagger):
        ...
        assert len(citations) == 1
        assert citations[0] == (15, 34, 'QUOTE')  # "Ajax hurled a rock"
    ...
    def test_multiple_citations(self, tagger):
        ...
        assert citations[0] == (7, 17, 'BIBL')
        assert citations[1] == (22, 26, 'QUOTE')
    ...
    def test_cit_tag(self, tagger):
        ...
        assert citations[0] == (3, 19, 'CIT')
        # BIBL comes first
        assert citations[1] == (3, 13, 'BIBL')
        # QUOTE comes after
        assert citations[2] == (13, 17, 'QUOTE')
    ...
    def test_nested_cit_bibl_quote(self, tagger):
        ...
        xml = '<p><cit><bibl>Hdt. 8.82</bibl>: <quote>Ajax hurled</quote></cit> text</p>'
